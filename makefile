main: main.cpp objects/inputreader.o objects/board.o objects/manhattan.o objects/bfs.o  objects/idfs.o objects/astar.o objects/idastar.o objects/gbfs.o
	g++ objects/result.o  objects/inputreader.o objects/board.o objects/manhattan.o objects/bfs.o objects/idfs.o objects/astar.o objects/idastar.o objects/gbfs.o main.cpp -o main 
