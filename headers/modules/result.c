...
void calculate_result(result *res, int otimal_cost)
{
    ...
    if(res->heuristics_calculated != 0)
        res->average_heurisctic =(double) res->total_heuristic/ res->heuristics_calculated;
